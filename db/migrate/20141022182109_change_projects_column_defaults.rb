class ChangeProjectsColumnDefaults < ActiveRecord::Migration
  def up
    change_column_default :projects, :how_to_url_block, '<a href="/docs/NITRO-ARM_Instructions.pdf" title="NITRO-ARM Web Site Instructions/Help/HowTo">Site instructions</a>'
