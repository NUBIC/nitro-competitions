...
#Rails.application.configure do
  ...
  # config.cache_classes = true # Removed in 5.2, defaults to false in development mode
  ...
  # config.assets.debug = true # Removed in upgrade to 5.2
  ...
  # config.active_job.queue_name_prefix = "nucats_assist_#{Rails.env}"
  ...
  config.app_domain = 'nitro-competitions.dev'
  ...
  config.active_record.dump_schema_after_migration = false   # Added with upgrade to 5.2, default on production is false
end
