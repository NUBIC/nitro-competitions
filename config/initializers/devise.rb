...
# cf. https://github.com/bkeepers/dotenv
require 'dotenv'
Dotenv.load
...
Devise.setup do |config|
  ...
  config.mailer_sender = "competitions@nubic.northwestern.edu"
  ...
  # config.pepper = "5780b1dd023ea8c641dc22636add95b44c4311ca4833d877b3b559ef3396f0c8d56064224d61736367020a2284f30320b0a26b23959c5f0ee8a84efae1558781"
  ...
  #  manager.default_strategies(:scope => :person).unshift :northwestern_medicine
  #end
